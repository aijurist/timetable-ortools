...
def main() -> None:
    parser = argparse.ArgumentParser(description="Split Year 2 course data by student_dept.")
    parser.add_argument(
        "input_csv",
        type=Path,
        default=Path("data/sem2026/year_wise/Year_2_course_data.csv"),
        nargs="?",
        help="Path to Year_2_course_data.csv",
    )
    parser.add_argument(
        "output_dir",
        type=Path,
        default=Path("data/sem2026/year_wise/2nd_year"),
        nargs="?",
