...
def main() -> None:
    parser = argparse.ArgumentParser(description="Split Year 1 course data by student_dept.")
    parser.add_argument(
        "input_csv",
        type=Path,
        default=Path("data/sem2026/year_wise/Year_1_course_data.csv"),
        nargs="?",
        help="Path to Year_1_course_data.csv",
    )
    parser.add_argument(
        "output_dir",
        type=Path,
        default=Path("data/sem2026/year_wise/1st_year"),
        nargs="?",
