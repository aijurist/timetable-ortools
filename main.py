...
def main():
    try:
        ...
        print("• Extended tutorial blocks: taa1/taa2, tbb1/tbb2, tcc1/tcc2 (v1/v2 excluded from assignments)")
        ...
        print("• PRIORITY CONSTRAINT: 4L, 3L+1T, 2L+2T courses restricted to a1-c2 blocks (extended tutorial support)")
