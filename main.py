...
def main():
    ...
    try:
        ...
        print("GROUP-BASED SCHEDULING SYSTEM (Lab scheduling ENABLED)")
        print("*" * 80)
        print("Key scheduling features:")
        print("• GROUP-BASED SCHEDULING: Dynamic timeslots per group based on course hours")
        ...
        print("• POST-PROCESSING: Course instances distributed across group timeslots")
        ...
        print("• 6 lab sessions per day: L1(8:00-9:40), L2(9:50-11:30), L3(11:50-1:30)")
        print("•   L4(1:50-3:30), L5(3:50-5:30), L6(5:30-7:10)")
        print("• Course types handled: Theory-only (T), Lecture+Tutorial (LoT), Practical")
        print("• ✅ PRACTICAL HOURS: Lab scheduling ENABLED with 2-hour sessions")
        print("• TEACHER UNIQUENESS: No teacher appears more than once in each group")
        print("• Conflict prevention: Teachers cannot have overlapping assignments")
        print("• Resource allocation: Classrooms for theory, Labs for practical")
        ...
        print("• COMPREHENSIVE: Full academic schedule for lecture, tutorial, and practical")
        print("*" * 80)
